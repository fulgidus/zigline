...
pub const firacode_regular_ttf = @embedFile("../../../assets/fonts/ttf/FiraCode-Regular.ttf");

/// Embedded FiraCode Bold font data
pub const firacode_bold_ttf = @embedFile("../../../assets/fonts/ttf/FiraCode-Bold.ttf");

/// Embedded FiraCode Light font data
pub const firacode_light_ttf = @embedFile("../../../assets/fonts/ttf/FiraCode-Light.ttf");

/// Embedded FiraCode Medium font data
pub const firacode_medium_ttf = @embedFile("../../../assets/fonts/ttf/FiraCode-Medium.ttf");
